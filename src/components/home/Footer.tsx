...
import { AppLogoSm } from '@/utils/icons';

const Footer = () => {
  return (
    <footer className="max-container padding-container pt-7 lg:pt-10 pb-8 mt-18 bg-primary-50">
      <div>
        <div className="lg:flex lg:justify-between">
          <div className="w-full lg:w-[30.0625rem]">
            <h6 className="text-white text-xl md:text-3xl lg:text-[2.5rem] font-semibold leading-8 lg:leading-[3rem]">
              Have a project idea! Let’s work together.
            </h6>
            <p className="mt-3 text-white text-base font-normal leading-7">
              Nunc vel metus cursus, tempor ipsum sit amet, rutrum justo.
              Maecenas tincidunt imperdiet magna, et porta libero eleifend vel.{' '}
            </p>
            <Link href="/quote" className="mt-6 flex justify-center items-center text-base text-[#1E2024] font-medium py-2 px-3 w-[7.625rem] h-11 lg:w-[11.125rem] lg:h-[4.0625rem] bg-secondary-60 rounded-[0.375rem]">
              Get a Quote
            </Link>
          </div>
          ...
          <div className="mt-11 lg:mt-0">
            ...
            <div className="flex gap-3 mt-3 lg:mt-[1.38rem]">
              <input
                className="flex-1 h-[3.25rem] w-full py-8 px-7 bg-[#EFEFEF] border border-[#D0D0D0] outline-none rounded-md placeholder:text-sm"
                placeholder="Enter Your Adress Email"
              />
              <button className=" text-base text-[#1E2024] font-medium py-2 px-3 bg-secondary-60 rounded-[0.375rem]">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-11 lg:mt-[6.94rem] lg:flex lg:justify-between">
        <div className="lg:order-1 lg:flex-1">
          <span className="text-base lg:text-xl text-white font-normal lg:font-semibold leading-7 lg:leading-8">
            Join our team. We’re open to hire creative peoples!
          </span>
          <div>
            <button className="text-base text-white font-bold px-8 mt-6 leading-[3rem] border-[1.5px] border-white rounded-[0.4375rem]">
              View open Position
            </button>
          </div>
        </div>

        <div className="lg:flex-1 mt-24 lg:mt-0 flex justify-center items-center gap-3 lg:order-3">
          <a href="#">
            <svg
              width="44"
              height="44"
              ...
              <rect width="44" height="44" rx="5" fill="#1E2024" />
              <path
          ...
          <a>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <rect width="44" height="44" rx="5" fill="#1E2024" />
              <g clipPath="url(#clip0_3023_3332)">
                <path
          ...
          <a>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <rect width="44" height="44" rx="5" fill="#1E2024" />
              <g clipPath="url(#clip0_3023_3333)">
                <path
          ...
          <a>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg">
              <rect width="44" height="44" rx="5" fill="#1E2024" />
              <g clipPath="url(#clip0_3023_3334)">
                <path
        ...
        <div className="lg:flex-1 flex justify-center items-center gap-2 mt-8 lg:mt-0 lg:order-2">
          <AppLogoSm />
          <span className="text-sm lg:text-[1.64rem] text-white font-semibold lg:font-ibm leading-5">
            {AppConfig.site_name}
          </span>
        </div>
        </div>
